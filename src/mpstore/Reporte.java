...
public class Reporte extends javax.swing.JFrame {
    ...
    public Reporte() {
        initComponents();
        this.setTitle("Reportes - MP store");
    ...
    void buscarEgreso(String buscar){
        ...
        try {
            con = DriverManager.getConnection(url, user, clave);
            stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM egresos WHERE fecha LIKE '%"+buscar+"%'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 310, -1, -1));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 270, -1, 30));
        ...
        getContentPane().add(jLabelCantidadGastos, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 270, 170, 30));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 350, -1, -1));
        ...
        getContentPane().add(jLabelCantidadVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 350, 170, 30));
        ...
        getContentPane().add(jLabelGastos, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 230, 170, 30));
        ...
        getContentPane().add(jLabelTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 390, 170, 30));
        ...
        getContentPane().add(jLabelBruto, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 310, 170, 30));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 390, -1, -1));
    ...
    void sumarDatosNeto(){
        ...
        for(int i=0; i<filas; i++){
            cont += Integer.parseInt((String) TablaDatos.getValueAt(i, 8));
        }
