...
public class Separado extends javax.swing.JFrame {
    ...
    public Separado() {
        initComponents();
        this.setTitle("Separado - MP store");
    ...
    private void initComponents() {
        ...
        jLabelMostrarNombre6.setOpaque(true);
        ...
        jTextFieldAbono.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 0, 0)));
        ...
        jLabelMostrarNombre4.setOpaque(true);
        ...
        getContentPane().add(jLabelLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 210, -1, -1));
    ...
    if (fila >0){
        for(int i=0;i<fila ; i++){
           String  requestDate = (String) TablaDatos.getValueAt(i, 4);
           
           LocalDate localDate1 = LocalDate.parse(requestDate, DateTimeFormatter.ofPattern("dd/MM/yyyy"));
           

           LocalDate currentDate = LocalDate.now();
           
           Period period = Period.between(localDate1, currentDate);
          

           
           
           String interes = "0."+period.getMonths();
           
           TablaDatos.setValueAt(interes, i, 7);
           
           double suma = Double.parseDouble((String) TablaDatos.getValueAt(i, 6)) * Double.parseDouble(interes) ;
           double total = suma + Double.parseDouble((String) TablaDatos.getValueAt(i, 6));
           
           TablaDatos.setValueAt(total, i, 8);
