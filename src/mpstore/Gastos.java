...
public class Gastos extends javax.swing.JFrame {
    ...
    void buscarProducto(String buscar){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM egresos");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 180, -1));
        ...
        getContentPane().add(jButtonListo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 430, -1, 40));
        ...
        getContentPane().add(jButtonCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 560, 230, 50));
    ...
    private void jButtonListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListoActionPerformed
        ...
        if(jTextDescripcion.getText().isEmpty()){
            ...
            try {
                con = DriverManager.getConnection(url, user, clave);
                stmt = con.createStatement();
                stmt.executeUpdate("INSERT INTO egresos VALUES('0', '"+jTextDescripcion.getText()+"','"+jTextFieldMonto.getText()+"','"+jTextFieldFecha.getText()+"')");
            } catch (SQLException ex) {
